...
Original file is located at
    https://colab.research.google.com/drive/10kA_jApUoFddyOgPZfylMLb4hoA0ufEm
"""

# -*- coding: utf-8 -*-
"""
Created on Thu Oct 15 16:43:19 2020
...
model.save('keras_model12.h5')
 #   validation_steps=len(validation_generator.filenames) // BATCH_SIZE

model = tf.keras.models.load_model('keras_model12.h5')
...
import shutil 
shutil.copytree('/content/drive/My Drive/archive_3','/content/BRAIN')
...
train_dir = os.path.join(path, 'train')
path2='/content/dataset2'
test_dir = os.path.join(path2, 'train')
print(train_dir)
print(test_dir)
print(os.listdir(train_dir))
...
model.save('/content/drive/My Drive/models/model100.h5')



import os
os.mkdir('/content/dataset2/train')

import shutil
import os

path = '/content/drive/My Drive/archive/train/yes'
path2 = '/content/dataset2/train/yes'
i = 1
...
for file_name in src_files:
    ...
    print("%s/%s" %(i,len(src_files)))
    i = i+1

import shutil
import os

path = '/content/drive/My Drive/archive_3/test/no'
path2 = '/content/dataset/test/no'
i = 1
src_files = os.listdir(path)
os.mkdir(path2)
for file_name in src_files:
